export const social = {
  ...
  'social.unfriendConfirmText': 'Удалить {name} из друзей? Чтобы вернуть дружбу, понадобится новая заявка.',
  'social.blockConfirmText': 'Заблокировать {name}? Пользователь не увидит ваш профиль и не сможет отправить заявку.',
  'social.blockConfirmFriendNote': 'Вы перестанете быть друзьями: разблокировка дружбу не вернёт.',
  ...
  'social.chatWrite': 'Написать',
  'social.chatOpen': 'Открыть чаты',
  'social.chatClose': 'Закрыть',
  'social.chatBack': 'Назад',
  'social.chatMessages': 'Сообщения',
  'social.chatFriends': 'Друзья',
  'social.chatNoHistory': 'История за 7 дней появится здесь.',
  'social.chatNoConversations': 'Откройте профиль друга и нажмите «Написать».',
  'social.chatLoadingHistory': 'Загрузка истории…',
  'social.chatEarlier': 'Раньше',
  'social.chatOffline': 'нет связи',
  'social.chatEdited': 'изменено',
  'social.chatCancel': 'Отмена',
  'social.chatSave': 'Сохранить',
  'social.chatReaction': 'Реакция',
