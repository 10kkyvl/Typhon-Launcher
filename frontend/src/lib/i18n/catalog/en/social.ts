...
export const social: Record<SocialKey, Message> = {
  ...
  'social.chatWrite': 'Message',
  'social.chatOpen': 'Open chats',
  'social.chatClose': 'Close',
  'social.chatBack': 'Back',
  'social.chatMessages': 'Messages',
  'social.chatFriends': 'Friends',
  'social.chatNoHistory': 'Your seven day history will appear here.',
  'social.chatNoConversations': 'Open a friend profile and choose “Message”.',
  'social.chatLoadingHistory': 'Loading history…',
  'social.chatEarlier': 'Earlier',
  'social.chatOffline': 'offline',
  'social.chatEdited': 'edited',
  'social.chatCancel': 'Cancel',
  'social.chatSave': 'Save',
  'social.chatReaction': 'Reaction',
