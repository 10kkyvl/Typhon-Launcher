...
export const social: Record<SocialKey, Message> = {
  ...
  'social.unfriendConfirmText': 'Remove {name} from your friends? Becoming friends again takes a new request.',
  'social.blockConfirmText': 'Block {name}? They will not see your profile and cannot send you a request.',
  'social.blockConfirmFriendNote': 'You will stop being friends: unblocking does not bring the friendship back.',
