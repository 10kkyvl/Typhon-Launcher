...
export const social: Record<SocialKey, Message> = {
  ...
  'social.friendCodeInline': 'Friend code: {code}',
  'social.copyFriendCodeLabel': 'Copy friend code',
  ...
  'social.friendsMyCodeTitle': 'My friend code',
  'social.friendsShareHint': 'Share the code with friends so they can add you on Typhon.',
